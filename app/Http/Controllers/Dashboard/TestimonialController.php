...
class TestimonialController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            Log::error('Testimonial Index Failed', ['error' => $th->getMessage()]);
    ...
    public function create()
    {
        ...
        try {
            ...
            Log::error('Testimonial Create Failed', ['error' => $th->getMessage()]);
            return redirect()->back()->with('error', "Something went wrong! Please try again later");
            throw $th;
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            Log::error('Testimonial Store Validation Failed', ['error' => $validator->errors()->all()]);
