                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                                name="name" required placeholder="{{ __('Enter name') }}" autofocus value="{{old('name', $testimonial->name)}}"/>
                            @error('name')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('designation') is-invalid @enderror" type="text" id="designation"
                                name="designation" required placeholder="{{ __('Enter designation') }}"  value="{{old('designation', $testimonial->designation)}}"/>
                            @error('designation')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            @if($testimonial->image)
                                <img src="{{ asset($testimonial->image) }}" alt="Meta Image" class="mt-2" width="120">
                            @endif
                        </div>
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('review_count') is-invalid @enderror" type="number" id="review_count"
                                name="review_count" required placeholder="{{ __('Enter review count') }}"  value="{{old('review_count', $testimonial->review_count)}}"/>
                            @error('review_count')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('review') is-invalid @enderror" id="review" name="review"
                                placeholder="{{ __('Enter review') }}" cols="30" rows="5" required>{{ old('review', $testimonial->review) }}</textarea>
                            @error('review')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
