                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                                name="name" required placeholder="{{ __('Enter service name') }}" autofocus value="{{old('name')}}"/>
                            @error('name')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('total_projects') is-invalid @enderror" type="number"
                                ...
                                placeholder="{{ __('Enter no of projects') }}"  value="{{old('total_projects')}}"/>
                                ...
                                @foreach ($icons as $key => $icon)
                                    <div class="form-check text-center">
                                        <input class="form-check-input d-none" type="radio" name="icon"
                                            id="icon{{ $key }}" value="{{ $icon }}" required {{ $selectedIcon === $icon ? 'checked' : '' }}>
