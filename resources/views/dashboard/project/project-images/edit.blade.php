                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" type="text" id="title"
                                name="title" required placeholder="{{ __('Enter project title') }}" autofocus value="{{old('title', $project->title)}}"/>
                            @error('title')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('slug') is-invalid @enderror" type="text" id="slug"
                                name="slug" required placeholder="{{ __('Enter service slug') }}"  value="{{old('slug', $project->slug)}}"/>
                            @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('meta_title') is-invalid @enderror" type="text"
                                ...
                                placeholder="{{ __('Enter service meta title') }}"  value="{{old('meta_title', $project->meta_title)}}"/>
                            @error('meta_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('meta_description') is-invalid @enderror" type="text"
                                ...
                                placeholder="{{ __('Enter service meta description') }}"  value="{{old('meta_description', $project->meta_description)}}"/>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                placeholder="{{ __('Enter service meta description') }}" cols="30" rows="10">{{old('description', $project->description)}}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            @if($project->meta_image)
                                <img src="{{ asset($project->meta_image) }}" alt="Meta Image" class="mt-2" width="120">
                            @endif
                        </div>
                        <div class="mb-4 col-md-6">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('client_name') is-invalid @enderror" type="text" id="client_name"
                                name="client_name" placeholder="{{ __('Enter project client name') }}" value="{{old('client_name', $project->client_name)}}"/>
                            @error('client_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('industry') is-invalid @enderror" type="text" id="industry"
                                name="industry" placeholder="{{ __('Enter project industry') }}" value="{{old('industry', $project->industry)}}"/>
                            @error('industry')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('technology') is-invalid @enderror" type="text" id="technology"
                                name="technology" placeholder="{{ __('Enter project technology') }}" value="{{old('technology', $project->technology)}}"/>
                            @error('technology')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('project_url') is-invalid @enderror" type="url" id="project_url"
                                name="project_url" placeholder="{{ __('Enter project url') }}" value="{{old('project_url', $project->project_url)}}"/>
                            @error('project_url')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('github_url') is-invalid @enderror" type="url" id="github_url"
                                name="github_url" placeholder="{{ __('Enter github url') }}" value="{{old('github_url', $project->github_url)}}"/>
                            @error('github_url')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <select id="status" name="status" class="select2 form-select @error('status') is-invalid @enderror">
                                ...
                                <option value="upcoming"{{ old('status', $project->status) == 'upcoming' ? 'selected' : '' }}>{{__('Upcoming')}}</option>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('completion_date') is-invalid @enderror" type="date" id="completion_date"
                                name="completion_date" placeholder="{{ __('Enter project completion date') }}" value="{{old('completion_date', date('Y-m-d', strtotime($project->completion_date)))}}" disabled/>
